...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
       ...
       <style>
          .gradient {
            background: linear-gradient(90deg, #dbcdd2 0%, #44a3cf 100%);
          }
        </style>
        </head>
        <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
            ...
            <nav id="header" class="fixed w-full z-30 top-0 text-white">
              <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
                ...
                <div class="pl-4 flex items-center">
                  <a class="toggleColour text-indigo-900 no-underline hover:no-underline font-bold text-2xl lg:text-4xl hover:text-indigo-500" href="#">
                    <svg class="h-12 inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.005 512.005">
                        <path style="opacity:1" fill="#8d53fe" d="M 242.5,78.5 C 318.226,73.2958 375.392,102.962 414,167.5C 441.909,223.52 441.243,279.186 412,334.5C 382.764,383.677 339.598,412.177 282.5,420C 221.041,425.303 170.208,404.803 130,358.5C 89.5535,305.047 80.8869,246.714 104,183.5C 131.371,123.62 177.538,88.6198 242.5,78.5 Z"/><
                        <path style="opacity:1" fill="#844eef" d="M 279.5,107.5 C 342.836,108.723 388.002,137.723 415,194.5C 435.693,251.688 426.027,303.021 386,348.5C 340.904,390.761 289.07,401.594 230.5,381C 173.643,354.971 144.31,310.637 142.5,248C 145.729,186.807 175.062,143.473 230.5,118C 246.462,112.109 262.795,108.609 279.5,107.5 Z"/><
                        <path style="opacity:1" fill="#7e4ce2" d="M 295.5,133.5 C 347.421,133.03 385.255,155.697 409,201.5C 425.975,243.795 421.308,283.462 395,320.5C 365.192,355.81 327.359,369.977 281.5,363C 232.769,351.269 202.269,321.102 190,272.5C 182.043,218.259 201.209,176.759 247.5,148C 262.685,140.043 278.685,135.21 295.5,133.5 Z"/><
                        <path style="opacity:1" fill="#7849d5" d="M 234.5,267.5 C 235.833,267.5 237.167,267.5 238.5,267.5C 238.5,266.5 238.5,265.5 238.5,264.5C 236.167,264.5 233.833,264.5 231.5,264.5C 231.5,260.167 231.5,255.833 231.5,251.5C 232.133,242.001 233.8,232.667 236.5,223.5C 250.739,182.615 279.572,161.281 323,159.5C 363.13,160.88 391.13,179.88 407,216.5C 420.168,257.671 410.668,292.504 378.5,321C 347.033,342.49 314.033,345.157 279.5,329C 255.109,315.389 240.109,294.889 234.5,267.5 Z"/><
                        <path style="opacity:1" fill="#7146c5" d="M 285.5,290.5 C 283.357,288.869 281.69,286.869 280.5,284.5C 283.04,282.334 282.373,281.334 278.5,281.5C 276.832,276.828 275.165,272.162 273.5,267.5C 275.048,267.179 275.715,266.179 275.5,264.5C 273.5,264.5 271.5,264.5 269.5,264.5C 269.5,263.167 269.5,261.833 269.5,260.5C 271.5,260.5 273.5,260.5 275.5,260.5C 275.5,259.5 275.5,258.5 275.5,257.5C 273.5,257.5 271.5,257.5 269.5,257.5C 269.5,256.5 269.5,255.5 269.5,254.5C 271.5,254.5 273.5,254.5 275.5,254.5C 275.5,253.5 275.5,252.5 275.5,251.5C 272.5,251.5 269.5,251.5 266.5,251.5C 267.919,250.549 269.585,250.216 271.5,250.5C 271.5,245.833 271.5,241.167 271.5,236.5C 272.404,237.209 272.737,238.209 272.5,239.5C 273.978,239.762 275.311,239.429 276.5,238.5C 275.355,235.058 274.021,231.725 272.5,228.5C 273.376,228.631 274.043,228.298 274.5,227.5C 288.295,194.764 312.962,179.598 348.5,182C 378.989,188.154 398.155,206.32 406,236.5C 409.731,279.759 390.564,306.593 348.5,317C 323.557,319.242 302.723,311.076 286,292.5C 285.536,291.906 285.369,291.239 285.5,290.5 Z"/><
                        <path style="opacity:1" fill="#e7dff5" d="M 297.5,281.5 C 298.5,281.5 299.5,281.5 300.5,281.5C 300.855,284.067 301.521,286.567 302.5,289C 302.167,289.5 301.833,290 301.5,290.5C 300.784,289.689 299.95,289.022 299,288.5C 297.699,289.893 296.199,290.393 294.5,290C 295.798,287.273 296.798,284.44 297.5,281.5 Z"/><
                        <path style="opacity:1" fill="#f2eefa" d="M 385.5,281.5 C 387.199,281.34 388.866,281.506 390.5,282C 391.022,282.561 391.355,283.228 391.5,284C 391.026,285.704 390.859,287.538 391,289.5C 389.301,290.406 387.467,290.739 385.5,290.5C 385.5,287.5 385.5,284.5 385.5,281.5 Z"/><
                        <path style="opacity:1" fill="#8560cd" d="M 387.5,283.5 C 389.337,283.639 389.67,284.306 388.5,285.5C 387.702,285.043 387.369,284.376 387.5,283.5 Z"/><
                ...
                <div class="block lg:hidden pr-4">
                  <button id="nav-toggle" class="flex items-center p-1 text-indigo-900 hover:text-indigo-600 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                ...
                <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
                 @if (Route::has('login'))
                    ...
                    <li class="mr-3">
                      ...
                      class="mx-auto lg:mx-0 bg-gradient-to-r from-indigo-900 bg-white text-indigo-900 font-bold rounded-full my-5 py-3 px-7 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                      >
                      Admin
                    </a>
                    </li>
                    @else
                    <li class="mr-3">
                      <a class="inline-block text-indigo-900 font-bold text-lg no-underline hover:text-indigo-500 hover:text-underline py-2 px-4" href="{{ route('login') }}">Login</a>
                    </li>
                    @if (Route::has('register'))
                    <li class="mr-3">
                      <a class="inline-block text-indigo-900 font-bold text-lg no-underline hover:text-indigo-500 hover:text-underline py-2 px-4" href="{{ route('register') }}">Register</a>
                    </li>
                   @endif
                   @endauth
                  </ul>
            ...
            <!--Precentacion Bienvenidos-->
            <div class="pt-24">
              <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                <!--Left Col-->
                <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">

                  <h1 class="my-4 text-5xl font-bold text-indigo-900 leading-tight">
                    Bienvenido a mi Porftafolio
                  </h1>
                  <p class="leading-normal text-2xl mb-8 text-black">
                   Aca encontraras toda la informacion acerca de mis habilidades y trabajos
                  </p>

                </div>
                <!--Right Col-->
                <div class="w-full sm:w-1/2 p-6">
                  <img class="w-full md:w-5/5 z-50"src="img/portafolio1.svg" />
                </div>
              </div>
            </div>

            {{-- Imagen precentacion bienvenidos --}}
            ...
            <section class="bg-white border-b py-8">
              <div class="container mx-auto flex flex-wrap pt-4 pb-12 text-center">

                <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-indigo-900">
                  Habilidades
                </h1>
                ...
                <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                  <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                    ...
                    <div class="flex flex-wrap no-underline hover:no-underline">
                      ...
                      <p class="text-black text-base px-6 mb-5 pt-5">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at ipsum eu nunc commodo posuere et sit amet ligula.
                      </p>
                    </div>

                  </div>
                  <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-8">
                ...
                <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    ...
                    <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-8">
                      <div class="flex items-center justify-center">
                          <img src="img/3.png" alt="JAVASCRIPT">
                      </div>
                    </div>
                </div>
                  ...
                  <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    ...
                    <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-8">
                      <div class="flex items-center justify-center">
                          <img src="img/4.png" alt="Bootstrap">
                      </div>
                    </div>
                  </div>
                  <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                      ...
                      <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-8">
                        <div class="flex items-center justify-center">
                            <img src="img/5.jpeg" width="75" height="75" alt="VUEJS">
                        </div>
                      </div>
                  </div>
                  <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                      ...
                      <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-8">
                        <div class="flex items-center justify-center">
                            <img src="img/6.png" width="75" height="75" alt="PHP">
                        </div>
                      </div>
                  </div>
                  ...
                  <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                      ...
                      <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-8">
                        <div class="flex items-center justify-center">
                            <img src="img/9.png" width="85" height="85" alt="NODEJS">
                        </div>
                      </div>
                  </div>
                  <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                      ...
                      <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-8">
                        <div class="flex items-center justify-center">
                            <img src="img/10.png" width="75" height="75" alt="PHP">
                        </div>
                      </div>
                  </div>
            ...
            <section class="container mx-auto text-center py-6">
                <div class="container max-w-5xl mx-auto m-8 text-center">
                    <h1 class="w-full my-2 text-5xl leading-tight text-center text-indigo-900 font-bold">
                      Acerca de mi
                    </h1>
                    ...
                    <div class="flex flex-wrap mt-30">
                      <div class="w-5/6 sm:w-1/2 p-6">
                        ...
                        <p class="text-black mb-8 static">
                          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at ipsum eu nunc commodo posuere et sit amet ligula.
                          <br />
                          <br />
                          ...
                          <a class="text-indigo-900 hover:bg-blue-300" href="#">GitHub</a>
                        </p>
                        <p class="text-black mb-8 inline-block">
                          Linkedin:
                          <a class="text-indigo-900 hover:bg-blue-300" href="#">Linkedin</a>
                        </p>
            ...
            <section class="bg-white border-b py-8">
                <div class="container mx-auto flex flex-wrap pt-4 pb-12 text-center">
                  ...
                  <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    ...
                    <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-8">
                      <div class="flex items-center justify-center">
                          <img src="img/laravel1.jpg" width="150" height="150" alt="laravel">
                      </div>
                    </div>
                  ...
                  <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                      ...
                      <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-8">
                        <div class="flex items-center justify-center">
                            <img src="img/laravel2.jpg" width="150" height="150" alt="laravel2">
                        </div>
                      </div>
                  </div>
                    <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                        ...
                        <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-8">
                        <div class="flex items-center justify-center">
                            <img src="img/Marketin Digital.jpg" width="150" height="150" alt="JAVASCRIPT">
                        </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                        ...
                        <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-8">
                        <div class="flex items-center justify-center">
                            <img src="img/analitica.jpg" width="150" height="150" alt="Analitica">
                        </div>
                        </div>
                    </div>
                    <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                        ...
                        <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-8">
                            <div class="flex items-center justify-center">
                                <img src="img/certificadogoogle.jpg" width="150" height="150" alt="Google Paginas">
                            </div>
                        </div>
                    </div>
                    <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                    ...
                    <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-8">
                        <div class="flex items-center justify-center">
                            <img src="img/E-Commerce.jpg" width="150" height="150" alt="E-commerce">
                        </div>
                    </div>
                   </div>
                </div>
            ...
            <section class="container mx-auto text-center py-6 mb-12">
                  ...
                  <div class="flex flex-wrap">
                    <div class="w-5/6 sm:w-1/2 p-6">
                      ...
                      <p class="text-black mb-8">
                        ...
                        <a class="text-indigo-900 underline" href="#">paginauno.com</a>
                      </p>
                    </div>
                    <div class="w-full sm:w-1/2 p-6">
                    ...
                    <div class="w-full sm:w-1/2 p-6 mt-6">
                      <div class="align-middle">
                        ...
                        <p class="text-black mb-8">
                          ...
                          <a class="text-indigo-900 underline" href="#">paginados.com</a>
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              {{-- Contacto --}}
            <section class="bg-white mx-auto text-center py-6 mb-12">
              <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-indigo-900">
                Contactame
              </h1>
              <div class="w-full mb-4">
              ...
              <h3 class="my-4 text-3xl leading-tight text-black font-bold">
                Las mejores cosas de la vida no son cosas
              </h3>
              <button class="mx-auto lg:mx-0 bg-gradient-to-r from-indigo-500 bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                Enviame mensaje
              </button>
            </section>

            <!--Footer-->
            <footer class="w-full container mx-auto flex flex-wrap items-center justify-between">
