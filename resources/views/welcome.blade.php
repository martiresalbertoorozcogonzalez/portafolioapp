       ...
       <style>
        ...
        <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
                ...
                <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
                 @if (Route::has('login'))
                    ...
                    <li class="mr-3">
                      ...
                      class="mx-auto lg:mx-0 bg-gradient-to-r from-red-500 bg-white text-gray-800 font-bold rounded-full my-5 py-3 px-7 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
                      >
                      Admin
                    </a>
                    </li>
                ...
                <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                  <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                    ...
                    <div class="flex flex-wrap no-underline hover:no-underline">
                      ...
                      <p class="text-gray-800 text-base px-6 mb-5 pt-5">
                ...
                <div class="container max-w-5xl mx-auto m-8">
                    ...
                    <div class="flex flex-wrap">
                      <div class="w-5/6 sm:w-1/2 p-6">
                        ...
                        <p class="text-gray-600 mb-8 static">
                          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at ipsum eu nunc commodo posuere et sit amet ligula.
                          <br />
                          <br />
                          ...
                          <a class="text-pink-500 hover:bg-blue-300" href="#">GitHub</a>
                        </p>
                        <p class="text-gray-600 mb-8 inline-block">
                          Linkedin:
                          <a class="text-pink-500 hover:bg-blue-300" href="#">Linkedin</a>
                        </p>
            ...
            <section class="container mx-auto text-center py-6 mb-12">
              ...
              <button class="mx-auto lg:mx-0 bg-gradient-to-r from-red-500 bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                Enviar mensaje
              </button>
            </section>
              ...
              <div class="container mx-auto px-8">
                <div class="w-full flex flex-col md:flex-row py-6">
                  <div class="flex-1 mb-6 text-black text-center">
                    ...
                    <p>Copyright &copy; Portafolio | Martires 2021 <a href="" target="_blank" rel="nofollow"></a></p>
                  </div>
                </div>
              </div>
            </footer>
