    ...
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <h1 class="text-center mb-5 text-lg font-bold">Editar Habilidad</h1>

                <form action="{{ route('habilidad.update',['habilidad'=> $habilidad->id]) }}" method="POST" enctype="multipart/form-data" class="max-w-lg mx-auto my-10">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-5">
                        ...
                        <input id="nombre" type="text"
                            ...
                            name="nombre" placeholder="nombre" value="{{ $habilidad->nombre }}">
                        @error('nombre')
                    ...
                    <div class="mb-5">
                        ...
                        <input type="hidden" id="descripcion" name="descripcion" value="{{$habilidad->descripcion}}">
                    ...
                    <div class="mb-5">
                        <label for="imagen">Imagen Habilidad</label>
                        <input id="imagen" type="file" name="imagen">

                        <div class="mt-4">
                            <p>Imagen Actual</p>
                            <img src="/storage/{{$habilidad->imagen}}" style="width:300px;">
                        </div>
                    ...
                    <div class="text-center pt-6">
                        <button href="#" class="bg-blue-500  hover:bg-blue-400 p-2 mb-2 rounded" type="submit">Editar Habilidad</button>
                    </div>
