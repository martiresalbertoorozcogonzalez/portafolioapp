    ...
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <h1 class="text-center mb-5 text-lg font-bold">Crear Certificacion</h1>

                <form action="{{ route('certificacion.store') }}" method="POST" enctype="multipart/form-data" class="max-w-lg mx-auto my-10">
                    @csrf
                    ...
                    <div class="mb-5">
                        ...
                        <input id="url_certificacion" type="text"
                            ...
                            name="url_certificacion" placeholder="url_certificacion" value="{{ old('url_certificacion') }}">
                    ...
                    <div class="mb-5">
                        <label for="imagen">Imagen Descripcion</label>
                    ...
                    <div class="text-center pt-6">
                        <button href="#" class="bg-blue-500  hover:bg-blue-400 p-2 mb-2 rounded" type="submit">Crear Certifiacion</button>
                    </div>
