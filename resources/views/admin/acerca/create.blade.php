    ...
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <h1 class="text-center mb-5 text-lg font-bold">Crear Acerca de </h1>

                <form action="{{ route('acerca.store') }}" method="POST" enctype="multipart/form-data" class="max-w-lg mx-auto my-10">
                    @csrf
                    ...
                    <div class="mb-5">
                        ...
                        <input id="url_linkedin" type="text"
                            ...
                            name="url_linkedin" placeholder="url_linkedin" value="{{ old('url_linkedin') }}">
                        @error('url_linkedin')
                        <div class="bg-red-200 border border-red-500 text-red-800 px-4 py-3 rounded relative mt-3 mb-6"
                            role="alert">
                            <strong class="font-bold">Error!!</strong>
                    ...
                    <div class="text-center pt-6">
                        <button href="#" class="bg-blue-500  hover:bg-blue-400 p-2 mb-2 rounded" type="submit">Crear Acerca</button>
                    </div>
