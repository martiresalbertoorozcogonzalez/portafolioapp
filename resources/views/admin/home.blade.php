            ...
            <div class="flex-1 p-4 lg:p-6 bg-white">
                ...
                <div class="grid grid-rows-4 grid-cols-1 gap-4 md:grid-rows-2 md:grid-cols-2">
                    ...
                    <a href="{{ route('portafolio.index') }}"
                         class="rounded-2x backdrop-filter backdrop-blur-lg bg-opacity-20 bg-blue-700 p-4 flex flex-col relative undefined text-center hover:bg-blue-300">
                    ...
                    <a href="#" class="rounded-2x backdrop-filter backdrop-blur-lg bg-opacity-20 bg-blue-700 p-4 flex flex-col relative undefined hover:bg-blue-300">
                        <div class="absolute right-2">
